...
table.render({
    elem: '#test'
    , url: url+'/information/anticoagulantList'
    , method: 'post'
    ...
    , cols: [[
        ...
        , {field: 'anticoagulantName', title: '抗凝剂名称', align: 'center', minWidth: 140}
...
table.on('tool(demo)', function (obj) {
    ...
    if (obj.event === 'detail') {
        ...
        layer.confirm('您确定要删除这条数据吗？', {
            ...
            var ids=data.id
            http.ajax({
                url: "/information/deleteAnticoagulant",
                type: "POST",
                dataType: "JSON",
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                layer.close(index)
                http.ajax({
                    url: "/information/updateAnticoagulant",
                    type: "POST",
                    dataType: "JSON",
                    beforeSend: function (XMLHttpRequest) {
                        XMLHttpRequest.setRequestHeader('Authorization', token);
    ...
    $("#unitAdd").click(function () {
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                http.ajax({
                    url: "/information/addAnticoagulant",
                    type: "POST",
                    dataType: "JSON",
                    beforeSend: function (XMLHttpRequest) {
                        XMLHttpRequest.setRequestHeader('Authorization', token);
