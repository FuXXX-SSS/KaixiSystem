...
table.render({
    elem: '#test'
    , url: url+'/information/bloodPreparationList'
    , method: 'post'
    ...
    , cols: [[
        ...
        , {field: 'bloodPreparation', title: '血样备注', align: 'center'}
...
var active={
    reload: function () {
        var bloodPreparation = $("#bloodPreparation").val();
        //执行重载
        table.reload('idTest', {
            page: {
                curr: 1
            ...
            , where: {
                bloodPreparation:bloodPreparation
            }
        });
    },
}
...
table.on('tool(demo)', function (obj) {
    ...
    if (obj.event === 'detail') {
        ...
        layer.confirm('您确定要删除这条数据吗？', {
            ...
            var ids=data.id
            http.ajax({
                url: "/information/deleteBloodPreparation",
                type: "POST",
                dataType: "JSON",
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                layer.close(index)
                http.ajax({
                    url: "/information/updateBloodPreparation",
                    type: "POST",
                    dataType: "JSON",
                    beforeSend: function (XMLHttpRequest) {
                        XMLHttpRequest.setRequestHeader('Authorization', token);
    ...
    $("#unitAdd").click(function () {
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                http.ajax({
                    url: "/information/addBloodPreparation",
                    type: "POST",
                    dataType: "JSON",
                    beforeSend: function (XMLHttpRequest) {
                        XMLHttpRequest.setRequestHeader('Authorization', token);
