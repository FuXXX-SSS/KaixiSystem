...
table.render({
	elem: '#test',
	url: url + '/bloodAuduting/queryNotApprove',
	method: 'post',
	...
	cols: [
		[
            ...
            { field: 'resultsApproveReason', title: '未批准原因', align: 'center', rowspan: 2, colspan: 1 },
	...
	addResult: function() {//批量添加结果	
		...
		console.log(data)									
			...
			if(resultId.trim() == ""){
				...
				data: { resultId: data.testResultId },
			}).then(function(data) {
					if (data.code == 0) {
						layer.msg('添加成功');
						table.reload('idTest', {});
